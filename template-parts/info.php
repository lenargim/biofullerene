  ...
  <div class="container">
    <div class="info__wrap">
      <div class="info__img-box">
        <img src="<?php echo IMAGES_PATH; ?>/info1.jpg" class="info__img img big" alt="big">
        <img src="<?php echo IMAGES_PATH; ?>/info2.jpg" class="info__img img small" alt="small">
        <img src="<?php echo IMAGES_PATH; ?>/info3.jpg" class="info__img img small" alt="small">
      ...
      <div class="info__text">
        ...
        <ol class="info__list">
          <?php while (have_rows('info-list')): the_row() ?>
            <li class="info__list-item"><span><?php the_sub_field('item') ?></span></li>
          <?php endwhile; ?>
        </ol>
      </div>
    </div>
